...
class Sacher_EPOS(LibraryDriver):
    ...
    # 2)
    def open(self):
        self.lib.OpenDevice.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p,
    ...
    def initialize(self):
        ...
        self.lib.GetOperationMode.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD,
        ...
        if pMode.contents.value != 1:
            self.lib.SetOperationMode.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.c_int8,
        ...
        self.lib.GetPositionProfile.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD,
                                                ctypes.POINTER(ctypes.wintypes.DWORD),
                                                ctypes.POINTER(ctypes.wintypes.DWORD),
                                                ctypes.POINTER(ctypes.wintypes.DWORD),
                                                ctypes.POINTER(ctypes.wintypes.DWORD)]
        ...
        ret = self.lib.GetPositionProfile(self._keyhandle, nodeID, pProfileVelocity, pProfileAcceleration,
        ...
        if (int(pProfileVelocity.contents.value) > int(11400) or int(pProfileAcceleration.contents.value) > int(
            ...
            self.lib.GetPositionProfile.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.wintypes.DWORD,
            ...
            ret = self.lib.SetPositionProfile(self._keyhandle, nodeID, pProfileVelocity, pProfileAcceleration,
                                              pProfileDeceleration, ctypes.byref(buf))
        ...
        """Coefficient A"""
        self.lib.GetObject.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.wintypes.WORD,
        ...
        ret = self.lib.GetObject(self._keyhandle, nodeID, StoredPositionObject, StoredPositionObjectSubindex,
                                 ObjectData, StoredPositionNbBytesToRead, StoredPositionNbBytesRead, ctypes.byref(buf))
    ...
    def get_motor_position(self):
        ...
        self.lib.GetPositionIs.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.POINTER(ctypes.c_long),
                                           ctypes.POINTER(ctypes.wintypes.DWORD)]
    ...
    def set_new_offset(self, new_offset):
        ...
        nodeID = ctypes.wintypes.WORD(0)
        buf = ctypes.wintypes.DWORD(0)
        self.lib.SetObject.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.wintypes.WORD,
        ...
        ret = self.lib.SetObject(self._keyhandle, nodeID, StoredPositionObject, StoredPositionObjectSubindex,
    ...
    def set_target_position(self, target, absolute, immediately):
        ...
        self.lib.MoveToPosition.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.c_long,
        ...
        while nchecks < 1000:
            ...
            self.lib.GetMovementState.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD,
    ...
    def get_motor_current(self):
        nodeID = ctypes.wintypes.WORD(0)
        self.lib.GetCurrentIs.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.POINTER(ctypes.c_uint8),
                                          ctypes.POINTER(ctypes.wintypes.DWORD)]
    ...
    def find_home(self):
        nodeID = ctypes.wintypes.WORD(0)
        self.lib.FindHome.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD, ctypes.c_uint8,
                                      ctypes.POINTER(ctypes.wintypes.DWORD)]
    ...
    def restore(self):
        nodeID = ctypes.wintypes.WORD(0)
        self.lib.FindHome.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.WORD,
                                      ctypes.POINTER(ctypes.wintypes.DWORD)]
        self.lib.FindHome.restype = ctypes.wintypes.BOOL
        buf = ctypes.wintypes.DWORD(0)
