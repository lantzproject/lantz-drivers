...
def LoadDLL(dll):
    ...
    dll.WaitForWLMEvent.argtypes = [ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_long),
    ...
    dll.WaitForWLMEventEx.argtypes = [ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_long),
    ...
    dll.WaitForNextWLMEvent.argtypes = [ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_long),
                                        ctypes.POINTER(ctypes.c_double)]
    ...
    dll.WaitForNextWLMEventEx.argtypes = [ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_long),
                                          ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_double),
                                          ctypes.POINTER(ctypes.c_long)]
    ...
    dll.ControlWLMEx.argtypes = [ctypes.c_long, ctypes.POINTER(ctypes.c_long), ctypes.c_long, ctypes.c_long,
                                 ctypes.c_long]
    ...
    dll.GetExtraSetting.argtypes = [ctypes.c_long, ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_double),
                                    ctypes.c_char_p]
    ...
    dll.GetAutoExposureSetting.argtypes = [ctypes.c_long, ctypes.c_long, ctypes.POINTER(ctypes.c_long),
                                           ctypes.POINTER(ctypes.c_double)]
    ...
    dll.GetAutoCalSetting.argtypes = [ctypes.c_long, ctypes.POINTER(ctypes.c_long), ctypes.c_long,
                                      ctypes.POINTER(ctypes.c_long)]
    ...
    dll.GetPIDSetting.argtypes = [ctypes.c_long, ctypes.c_long, ctypes.POINTER(ctypes.c_long),
                                  ctypes.POINTER(ctypes.c_double)]
    ...
    dll.GetLaserControlSetting.argtypes = [ctypes.c_long, ctypes.c_long, ctypes.POINTER(ctypes.c_long),
    ...
    dll.SetLaserControlSetting.argtypes = [ctypes.c_long, ctypes.c_long, ctypes.c_long, ctypes.c_double,
                                           ctypes.c_char_p]
