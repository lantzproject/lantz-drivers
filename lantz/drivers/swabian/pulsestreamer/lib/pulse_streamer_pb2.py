...
PulseStreamerStringReply = _reflection.GeneratedProtocolMessageType('PulseStreamerStringReply', (_message.Message,),
                                                                    dict(
...
try:
    ...
    def beta_create_PulseStreamer_server(servicer, pool=None, pool_size=None, default_timeout=None,
        ...
        method_implementations = {
            ...
            ('pulse_streamer.PulseStreamer', 'enableStaticIP'): face_utilities.unary_unary_inline(
                servicer.enableStaticIP),
            ...
            ('pulse_streamer.PulseStreamer', 'getDebugRegister'): face_utilities.unary_unary_inline(
                servicer.getDebugRegister),
            ('pulse_streamer.PulseStreamer', 'getFirmwareVersion'): face_utilities.unary_unary_inline(
                servicer.getFirmwareVersion),
            ('pulse_streamer.PulseStreamer', 'getNetworkConf'): face_utilities.unary_unary_inline(
                servicer.getNetworkConf),
            ...
            ('pulse_streamer.PulseStreamer', 'setDebugRegister'): face_utilities.unary_unary_inline(
                servicer.setDebugRegister),
            ('pulse_streamer.PulseStreamer', 'setNetworkConf'): face_utilities.unary_unary_inline(
                servicer.setNetworkConf),
            ...
            ('pulse_streamer.PulseStreamer', 'testNetworkConf'): face_utilities.unary_unary_inline(
                servicer.testNetworkConf),
        }
    ...
    def beta_create_PulseStreamer_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
        ...
        stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer,
                                                         ...
                                                         thread_pool=pool, thread_pool_size=pool_size)
        return beta_implementations.dynamic_stub(channel, 'pulse_streamer.PulseStreamer', cardinalities,
