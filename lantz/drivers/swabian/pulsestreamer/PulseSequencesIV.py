...
class Pulses(Driver):
    default_digi_dict = {"laser": "ch0", "offr_laser": "ch1", 'current_gate': 'ch2', 'laser2': 'ch3', "EOM": "ch4",
                         "CTR": "ch5", "switch": "ch6", "gate": "ch7", "": None}
    default_digi_dict = {"laser": 0, "offr_laser": 1, 'current_gate': 2, 'laser2': 3, "EOM": 4, "CTR": 5, "switch": 6,
                         "gate": 7, "": None}
    rev_dict = {0: "laser", 1: "offr_laser", 2: 'current_gate', 3: 'laser2', 4: "EOM", 5: "CTR", 6: "switch", 7: "gate",
                8: "I", 9: "V"}
    ...
    def __init__(self, channel_dict=default_digi_dict, laser_time=150 * Q_(1, "us"), readout_time=150 * Q_(1, "us"),
        ...
        self._reverse_dict = {0: "laser", 1: "offr_laser", 2: 'current_gate', 3: 'laser2', 4: "EOM", 5: "CTR",
                              6: "switch", 7: "gate", 8: "I", 9: "V"}  # rev_dict
