"""
    lantz.drivers.physik_instrumente.piezo
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Implements the drivers to control physik_instrumente E-709 piezo motion controller
...
class Piezo(MessageBasedDriver):
    ...
    stage = physik_instrumente.Piezo('ASRL/dev/ttyUSB0::INSTR', axis='X',
